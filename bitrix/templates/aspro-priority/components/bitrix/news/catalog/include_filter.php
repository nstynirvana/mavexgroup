...
if($arTheme['SHOW_SMARTFILTER']['VALUE'] !== 'N' && $itemsCnt){
	if($arTheme['SHOW_SMARTFILTER']['DEPENDENT_PARAMS']['FILTER_VIEW']['VALUE'] == 'COMPACT'){
        $template = 'main_compact';
    } else {
        $template = 'catalog';
    }
	if($arTheme['SHOW_SMARTFILTER']['DEPENDENT_PARAMS']['FILTER_VIEW']['VALUE'] == 'VERTICAL'){
		...
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'COUNT_IN_FILTER' => $arParams['COUNT_IN_FILTER'],
