...
<?if($arResult['ITEMS']):?>
	...
	?>
	<div class="item-views tarifs wicons type_4 type_5 tarifs_scroll linked">
		<?//items?>
		<div class="items unstyled front dark-nav view-control navigation-vcenter" data-plugin-options='{"useCSS": false, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "counts": [4, 3, 2, 1], "itemMargin": 0}'>
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				?>
				<div class="item border shadow<?=!$bImage ? ' wti' : ''?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>"<?=($bOrderViewBasket ? ' data-item="'.$dataItem.'"' : '')?>>
					<div class="wrap">
						<div class="row">
