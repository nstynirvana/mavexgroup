...
if($arResult['SECTIONS']){
	...
	*/
	...
	if($arTheme['USE_REGIONALITY']['VALUE'] === 'Y' && $arRegion && CPriority::GetFrontParametrValue('REGIONALITY_FILTER_ITEM') === 'Y'){
	...
	foreach($arResult['SECTIONS'] as $SID => &$arSection){
		...
		if(!$arSection['ELEMENTS_COUNT'] && $arTheme['USE_REGIONALITY']['VALUE'] === 'Y' && $arRegion && CPriority::GetFrontParametrValue('SHOW_SECTIONS_REGION') == 'Y'){
