...
<?if($arResult['SECTIONS']):?>
	<div class="item-views within type_2_within services-items sections view_2" <?=$arParams['COMPACT_VIEW'] ? 'id="compact-view-mobile-catalog-sections"' : ''?>>
		<div class="items clearfix">
			<?foreach($arResult['SECTIONS'] as $arItem):?>
				...
				if($bShowSectionImage = in_array('PREVIEW_PICTURE', $arParams['FIELD_CODE'])){
					...
					$arSectionImage = ($bImage ? CFile::ResizeImageGet($arItem['~PICTURE'], array('width' => 60, 'height' => 60), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true) : array());
