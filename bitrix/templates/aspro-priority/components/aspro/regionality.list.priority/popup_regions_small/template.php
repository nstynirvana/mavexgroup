			...
			<div class="io_wrapper">
				...
				<?if($arResult['SHOW_REGION_CONFIRM']):?>
					<div class="confirm_region">
						<span class="regionConfirmClose" data-id=<?=$arResult['CURRENT_REGION']['ID']?>><?=CPriority::showIconSvg(SITE_TEMPLATE_PATH.'/images/include_svg/close.svg');?></span>
						<?
...
<?else:?>
	<div class="popup_regions">
		...
		<?if(\Bitrix\Main\Config\Option::get('aspro.priority', 'REGIONALITY_SEARCH_ROW', 'N') != 'Y'):?>
			<script>
