...
$arTemplateParameters = array_merge($arPageBlocksParams, array(
	...
	'S_ORDER_PROJECT' => array(
		'SORT' => 701,
		'NAME' => GetMessage('S_ORDER_PROJECT'),
		'TYPE' => 'TEXT',
		'DEFAULT' => '',
	),
	...
	"TYPE_HEAD_BLOCK" => Array(
		...
		"VALUES" => array(
			...
			"mix" => GetMessage("T_MIX"), 
			"links" => GetMessage("T_LINKS"),
		),
		"DEFAULT" => "FROM_MODULE",
	),
...
$arTemplateParameters['LIST_PRODUCT_BLOCKS_ALL_ORDER'] = array(
	...
	'DEFAULT' => 'order,sale,desc,char,projects,faq,docs,video,gallery,comments,brand,services,goods,partners,reviews,staff,vacancys'
);
?>