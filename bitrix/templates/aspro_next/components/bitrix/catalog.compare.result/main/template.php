...
$compareUrlFromModule = trim($arTheme['COMPARE_PAGE_URL']['VALUE']);
$compareUrl = $compareUrlFromModule ? $compareUrlFromModule : SITE_DIR.'catalog/compare.php';
?>
...
<div class="bx_sort_container tabs">
	...
	<span class="wrap_remove_button">
		...
		<span data-test="<?=(trim($arTheme['COMPARE_PAGE_URL']['VALUE']));?>" class="btn btn-default white grey remove_all_compare icon_close" onclick="CatalogCompareObj.MakeAjaxAction('<?=$compareUrl;?>?action=DELETE_FROM_COMPARE_RESULT&ID[]=<?=$arStr?>', 'Y');"><?=GetMessage("CLEAR_ALL_COMPARE")?></span>
	</span>
</div>
