		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="unstyled  front">
					<div class=" slides items flexbox loader_circle owl-carousel owl-theme owl-bg-nav short-nav hidden-dots swipeignore" data-plugin-options='{"nav": true, "autoplay" : false, "autoplayTimeout" : "3000", "smartSpeed":1000, <?=(count($arResult["ITEMS"]) > 3 ? "\"loop\": true," : "")?> "responsiveClass": true, "margin":32, "responsive":{"0":{"items": 1, "margin":0}, "431":{"items": 2, "margin":0},"601":{"items": 3, "margin":0},"768":{"items": 3},"1200":{"items": 3}}}'>
						<?foreach($arResult['ITEMS'] as $i => $arItem):?>
							...
							?>
							<div class="item col-md-4 colsm-6" data-id="<?=$arItem['ID'];?>">
										...
										<div class="image<?=($bImage ? "" : " wti" );?>">
											<div class="wrap">
												<?if($bDetailLink):?><a href="<?=$arItem['DETAIL_PAGE_URL']?>"><?endif;?>
													<?$img = ($bImage ? CFile::ResizeImageGet($arItem['PREVIEW_PICTURE']['ID'], array('width' => 568, 'height' => 10000), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true) : array());?>
