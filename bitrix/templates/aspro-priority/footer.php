...
<? if (!$isIndex && !$isCatalog && !$isProjects): ?>
    ...
    <? else: ?>
        ...
        <? elseif ($isMenu && $arTheme["SIDE_MENU"]["VALUE"] == "LEFT" && !$isBlog && !$isServices): ?>
...
<? CPriority::AjaxAuth(); ?>
<? CPriority::bottomActions(); ?>
<script type="text/javascript" src="/bitrix/templates/aspro-priority/js/slick.min.js"></script>
</body>
</html>