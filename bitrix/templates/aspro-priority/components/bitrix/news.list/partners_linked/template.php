				...
				<div class="items row">
					...
					<?foreach($arResult['ITEMS'] as $arItem):?>
						...
						<div class="col-md-12 col-sm-12">
							<div class="item_wrap border shadow accordion-close" data-parent="#<?=$idPartner?>" data-target="#<?=$idPartner?>" data-toggle="collapse"">
								<div class="item clearfix<?=($bShowSectionImage && strlen($imageSectionSrc) ? '' : ' wti')?> <?=$arParams['IMAGE_CATALOG_POSITION'];?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
									...
									<div class="info panel-collapse collapse wrap_compact_mobile" id="<?=$idPartner?>">
										<?// section name?>
									...
									<?endif?>
									<?if((in_array('PREVIEW_TEXT', $arParams['FIELD_CODE']) && strlen($arItem['PREVIEW_TEXT'])) || ($arItem["DISPLAY_PROPERTIES"])):?>
