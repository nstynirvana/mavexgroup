	...
	<div class="col-md-<?=($arElement['PROPERTY_FORM_QUESTION_VALUE'] == 'Y' ? '9' : '12');?>">
		<div class="catalog" id="right_block_ajax">
			...
			{*/
				...
				$iCountElement = CCache::CIblockElement_GetList(array('CACHE' => array('TAG' => CCache::GetIBlockCacheTag($arParams['CATALOG_IBLOCK_ID']), 'MULTI' => 'N')), array_merge($arFilter, (array)$GLOBALS[$arParams["FILTER_NAME"]]), array());
				if($iCountElement)
				{
