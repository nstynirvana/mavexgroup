...
<?if($arResult['SECTIONS']):?>
	<div class="item-views services-items type_5 icons type_2_within view_4"  <?=$arParams['COMPACT_VIEW'] ? 'id="compact-view-mobile-catalog-sections"' : ''?>>
		<div class="items flexbox">
			<?foreach($arResult['SECTIONS'] as $arItem):?>
				...
				?>
				<div class="item shadow border<?=($bShowSectionImage && $imageSectionSrc ? '' : ' wti')?> <?=$arParams['IMAGE_CATALOG_POSITION'];?><?=($bBackground ? ' wbg' : '');?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
					<div class="wrap">
