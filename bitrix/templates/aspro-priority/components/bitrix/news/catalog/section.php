	...
	<div class="row relative">
		...
		<?endif;?>
				...
				<?else:?>
					...
					<div class="main-section-wrapper<?=($arSection['UF_TOP_SEO'] && strpos($_SERVER['REQUEST_URI'], 'PAGEN') === false ? ' wdesc' : '');?><?=($horizontalFilter ? ' whorizontal_filter' : '')?><?=($arSeoItem ? ' wlanding' : '')?>">
