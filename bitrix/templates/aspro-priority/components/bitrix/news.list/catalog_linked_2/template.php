...
<?if($arResult['SECTIONS'] || $arResult['ITEMS']):?>
	...
	<div class="catalog item-views table front linked">
		<div class="row margin0">
			<div class="flexslider unstyled row dark-nav swipeignore" data-plugin-options='{"useCSS": false, "animation": "slide", "directionNav": true, "controlNav": false, "animationLoop": true, "slideshow": false, "itemMargin": 0, "counts": [<?=$countmd?>, <?=$countsm?>, <?=$countxs?>, <?=$countxs1?>]}'>
