								...
								<?if(strlen($arItem['PROPERTY_PRICE_VALUE']) || strlen($arItem['PROPERTY_PRICEOLD_VALUE'])):?>
									<div class="prices">
										<?if(strlen($arItem['PROPERTY_PRICE_VALUE'])):?>
											<div class="price_new"><div><?=CPriority::replaceCurrency($arItem['PROPERTY_PRICE_VALUE'], $arItem['PROPERTY_PRICE_CURRENCY_VALUE'])?></div></div>
										<?endif;?>
										<?if(strlen($arItem['PROPERTY_PRICEOLD_VALUE'])):?>
											<div class="price_old"><div><?=CPriority::replaceCurrency($arItem['PROPERTY_PRICEOLD_VALUE'], $arItem['PROPERTY_PRICE_CURRENCY_VALUE'])?></div></div>
										<?endif;?>
									</div>
								<?endif;?>
								<div class="buy_block">
