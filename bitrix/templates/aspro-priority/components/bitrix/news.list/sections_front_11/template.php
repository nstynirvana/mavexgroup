...
<?if($arResult['SECTIONS']):?>
	<div class="item-views services-items type_4 template_11 front icons<?=(isset($arParams['SCROLL_CLASS']) && $arParams['SCROLL_CLASS'] ? ' '.$arParams['SCROLL_CLASS'] : '')?> <?=$bCompact ? 'compact-view' : ''?>">
								...
								<div class="wrap clearfix">
									...
									<div class="body-info">
										...
										<?if( in_array('PREVIEW_TEXT', $arParams['FIELD_CODE']) && strlen($isElements ? $arItem['PREVIEW_TEXT'] : $arItem['DESCRIPTION']) ):?>
											<div class="previewtext font-sm"><?=CPriority::truncateLengthText($isElements ? $arItem['PREVIEW_TEXT'] : $arItem['DESCRIPTION'], $arParams['PREVIEW_TRUNCATE_LEN'])?></div>
										<?endif?>
									</div>
								</div>
							</div>
