...
$templateData = array(
	...
	'LINK_BRANDS' => $arResult['PROPERTIES']['LINK_BRAND']['VALUE'] ? (array)$arResult['PROPERTIES']['LINK_BRAND']['VALUE'] : [],
	...
	'LINK_TARIFS' => (array)$arResult['DISPLAY_PROPERTIES']['LINK_TARIFS']['VALUE'],
	'BRAND_ITEM' => (array)$arResult['BRAND_ITEM'],
	'GALLERY_BIG' => (array)$arResult['GALLERY'],
	'CHARACTERISTICS' => (array)$arResult['CHARACTERISTICS'],
