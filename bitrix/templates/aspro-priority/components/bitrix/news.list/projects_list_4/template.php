	...
	<div class="item-views news-items projects type_4 linked">
		...
		<div class="items row">
			<?foreach($arResult['ITEMS'] as $i => $arItem):?>
				...
				?>
				<div class="item clearfix<?=(!$bImage ? ' wti' : '')?><?=($textColor ? ' '.$textColor : '')?> col-md-4 col-sm-4 col-xs-6 <?=$arResult['SECTIONS_ELEMENTS'][$arItem['ID']]?> <?=$arItem['FILTER_DATE']?>" data-ref="mixitup-target">
