...
<?if($arResult['SECTIONS']):?>
	<div class="item-views catalog sections type_4_within type_12_within section-12">
		<div class="items row margin0 list_block">
			<?foreach($arResult['SECTIONS'] as $arItem):?>
				...
				<div class="col-md-12 col-sm-12">
					<div class="item border shadow<?=($bShowSectionImage ? '' : ' wti')?>  <?=$arParams['IMAGE_CATALOG_POSITION'];?><?=($bBackground ? ' wbg' : '');?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
								...
								<div class="text childs">
									<ul>
										...
										<?$detailPageUrl = $arSubItem['DETAIL_PAGE_URL'];?>
											...
											<?endif;?>
											<li class="font_sm"><a class="colored" href="<?=($arSubItem['SECTION_PAGE_URL'] ? $arSubItem['SECTION_PAGE_URL'] : $detailPageUrl );?>"><?=$arSubItem['NAME']?></a></li>
										<?endforeach;?>
									</ul>
								</div>
							<?endif;?>
