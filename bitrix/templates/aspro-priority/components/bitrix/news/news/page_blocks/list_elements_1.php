<?if(\Bitrix\Main\Loader::includeModule('subscribe')):?>
	<?ob_start();?>
		<div class="ask_a_question border shadow subscribe fixed">
			...
			<div class="outer">
				<span class="font_upper animate-load" data-event="jqm" data-param-id="subscribe" data-param-type="subscribe" data-name="subscribe"><?=GetMessage('SUBSCRIBE_BUTTON')?></span>
			</div>
		</div>
