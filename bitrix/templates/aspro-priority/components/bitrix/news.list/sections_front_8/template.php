...
<?if($arResult['SECTIONS']):?>
	<div class="item-views services-items type_3 template_8 front<?=(isset($arParams['SCROLL_CLASS']) && $arParams['SCROLL_CLASS'] ? ' '.$arParams['SCROLL_CLASS'] : '')?> <?=$bCompact ? 'compact-view' : ''?>">
