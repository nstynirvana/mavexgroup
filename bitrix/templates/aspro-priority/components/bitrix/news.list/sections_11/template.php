...
<?if($arResult['SECTIONS']):?>
	<div class="item-views icons within type_2_within type_3_within services-items type_11 view_6"  <?=$arParams['COMPACT_VIEW'] ? 'id="compact-view-mobile-catalog-sections"' : ''?>>
