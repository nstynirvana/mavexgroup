		...
		<?if(!empty($arResult['SOCIAL_PINTEREST'])):?>
			<li class="pinterest">
				<a href="<?=$arResult['SOCIAL_PINTEREST']?>" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_PINTEREST')?>">
					<?=CPriority::showIconSvg(SITE_TEMPLATE_PATH.'/images/include_svg/pinterest.svg');?>
				</a>
			</li>
		<?endif;?>		
		<?if(!empty($arResult['SOCIAL_WHATS'])):?>
			<li class="whats">
				<a href="<?=$arResult['SOCIAL_WHATS']?>" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_WHATS')?>">
					<?=CPriority::showIconSvg(SITE_TEMPLATE_PATH.'/images/include_svg/whats.svg');?>
				</a>
			</li>
		<?endif;?>
		<?if(!empty($arResult['SOCIAL_VIBER'])):?>
			<li class="viber">
				<a href="<?=$arResult['SOCIAL_VIBER']?>" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_VIBER')?>">
					<?=CPriority::showIconSvg(SITE_TEMPLATE_PATH.'/images/include_svg/viber.svg');?>
				</a>
			</li>
		<?endif;?>		
	</ul>
