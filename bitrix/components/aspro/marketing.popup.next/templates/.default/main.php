				...
				<div class="popup-text-info__text font_sm">
					...
					<?if($bBtn1 || $bBtn2):?>
						...
						<div class="popup-text-info__btn">
							...
							<?endif;?>
							<?if($bBtn2):?>
								<a class="btn <?=($arResult['ITEM']['BTN2_CLASS_INFO']['XML_ID'] ? $arResult['ITEM']['BTN2_CLASS_INFO']['XML_ID'] : "btn-default white");?> btn-lg" href="<?=SITE_DIR?><?=$arResult['ITEM']["PROPERTY_BTN2_LINK_VALUE"];?>"><?=$arResult['ITEM']['PROPERTY_BTN2_TEXT_VALUE'];?></a>
							<?endif;?>
						</div>
					<?endif;?>
				</div>
