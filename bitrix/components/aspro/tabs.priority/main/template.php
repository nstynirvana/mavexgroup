	...
	<div class="item-views catalog sections1 front blocks">
		<div class="maxwidth-theme">
			<div class="tabs_ajax">
				...
				<div class="head-block pull-right tabs horizontal-scrolling" <?=(count($arResult["TABS"]) == 1 ? "style='display:none;'" : "");?> data-plugin-options='{"axis": "x", "scrollInertia": 200, "snapAmount": 70, "scrollButtons": {"enable": true}}' >
				...
				<div class="head-block media tabs horizontal-scrolling" <?=(count($arResult["TABS"]) == 1 ? "style='display:none;'" : "");?> data-plugin-options='{"axis": "x", "scrollInertia": 200, "snapAmount": 70, "scrollButtons": {"enable": true}}' >
					<div class="scroll-tabs-wrapper">
						<?$i = 0;?>
						<?foreach($arResult["TABS"] as $key => $arItem):?>
							<div class="item-link <?=(!$i ? 'active clicked' : '');?>">
