										...
										<div class="bottom">
											<div class="prices">
												<?if(isset($arItem['PROPERTY_PRICE_VALUE']) && strlen($arItem['PROPERTY_PRICE_VALUE'])):?>
													<div class="price_new">
														<span class="price_val"><?=CPriority::replaceCurrency($arItem['PROPERTY_PRICE_VALUE'], $arItem['PROPERTY_PRICE_CURRENCY_VALUE'])?></span>
													</div>
												<?endif;?>
												<?if(isset($arItem['PROPERTY_PRICEOLD_VALUE']) && strlen($arItem['PROPERTY_PRICEOLD_VALUE'])):?>
													<div class="price_old">
														<span class="price_val"><?=CPriority::replaceCurrency($arItem['PROPERTY_PRICEOLD_VALUE'], $arItem['PROPERTY_PRICE_CURRENCY_VALUE'])?></span>
													</div>
												<?endif;?>
											</div>
											<div class="buy_block">
