...
if(\Bitrix\Main\Loader::includeModule('aspro.priority')){
	...
	CPriority::AddComponentTemplateModulePageBlocksParams(__DIR__, $arPageBlocksParams, array('SECTION' => 'SERVICES_PAGE', 'OPTION' => 'SECTION_TYPE_VIEW', 'CUSTOM_PARAM' => 'SERVICES_SECTION_TYPE_VIEW')); // add option value FROM_MODULE
...
$arTemplateParameters = array_merge($arPageBlocksParams, array(
	...
	'COUNT_COL_GALLERY' => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'SORT' => 604,
		'NAME' => GetMessage('COUNT_COL_GALLERY'),
		"TYPE" => "LIST",
		'DEFAULT' => '4',
		'VALUES' => array(
			'2' => '2',
	...
	'TIZERS_IBLOCK_ID' => array(
		...
		'TYPE' => 'TEXT',
		'DEFAULT' => '={CCache::$arIBlocks[SITE_ID]["aspro_priority_advt"]["aspro_priority_tizers"][0]}',
	),
