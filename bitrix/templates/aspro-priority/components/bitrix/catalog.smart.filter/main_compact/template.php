		...
		<div class="bx_filter_section clearfix">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				...
				<div class="bx_filter_parameters">
					...
					<?endforeach;
					$isFilter=false;
					$numVisiblePropValues = $arParams['COUNT_IN_FILTER'];
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
						...
						<div class="bx_filter_parameters_box prop_type_<?=$arItem["PROPERTY_TYPE"];?><?=(isset($arItem['PROPERTY_SET']) && $arItem['PROPERTY_SET'] == 'Y' ? ' set' : '');?>" data-prop_code=<?=strtolower($arItem["CODE"]);?> data-property_id="<?=$arItem["ID"]?>">
							...
							<div class="bx_filter_block <?=($arItem["CODE"]=="IN_STOCK" ? "limited_block" : "");?>" <?=$style;?>>
								...
								switch ($arItem["DISPLAY_TYPE"]){
									...
									case "G"://CHECKBOXES_WITH_PICTURES
										...
										<?if($isHidden):?>
											...
											<div class="more_button_place"></div>
								...
								<?if($arItem['CODE'] != 'IN_STOCK'):?>
									<div class="bx_filter_button_box active clearfix">
										<span class="btn btn-default btn-xs"><?=Loc::getMessage("CT_BCSF_SET_FILTER")?></span>
										<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
									</div>
								<?endif;?>
							</div>
					...
					<div class="bx_filter_button_box active hidden">
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container clearfix">
								...
								<button class="bx_filter_search_reset btn btn-default white grey pull-left" title="<?=Loc::getMessage("CT_BCSF_DEL_FILTER")?>" type="reset" id="del_filter" name="del_filter" data-href=""></button>
