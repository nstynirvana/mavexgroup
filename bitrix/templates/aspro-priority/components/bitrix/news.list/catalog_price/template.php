								...
								<?if($bOrderButton):?>
									...
									<?if($bOrderButton && !$bOrderViewBasket):?>
										<div class="col-md-3 col-sm-3">
											<div class="button">
												<span class="btn btn-default pull-right animate-load" data-event="jqm" data-param-id="<?=CPriority::getFormID("aspro_priority_order_product");?>" data-autoload-product="<?=CPriority::formatJsName($arItem['NAME'])?>" data-name="order_product"><?=(strlen($arParams['S_ORDER_PRODUCT']) ? $arParams['S_ORDER_PRODUCT'] : GetMessage('S_ORDER_PRODUCT'))?></span>
											</div>
										</div>
