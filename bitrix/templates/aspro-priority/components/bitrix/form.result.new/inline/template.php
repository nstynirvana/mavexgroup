...
<div class="form inline form_page<?=($arResult['FORM_NOTE'] ? ' success' : '')?><?=($arResult['isFormErrors'] == 'Y' ? ' error' : '')?>">
	<!--noindex-->
		...
		<div class="form-footer">
			<?if($arParams["SHOW_LICENCE"] == "Y"):?>
				...
				<div class="licence_block bx_filter">
					<input type="checkbox" id="licenses_inline_<?=$arResult["arForm"]["ID"];?>" <?=(COption::GetOptionString("aspro.priority2", "LICENCE_CHECKED", "N") == "Y" ? "checked" : "");?> name="licenses_popup" required value="Y">
			...
			<div class="required_note">
				<span class="required-star">*</span> &mdash; <span><?=GetMessage("FORM_NOTE_REQUIRED")?><span>
			</div>
		</div>
