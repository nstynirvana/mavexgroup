...
<?
global $arTheme;
$bPrintButton = (CPriority::GetFrontParametrValue('PRINT_BUTTON') == 'Y' ? true : false);
?>
                    ...
                    <div class="info">
                        <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="subscribe_button">
                                        <span class="btn" data-event="jqm" data-param-id="subscribe"
                                              ...
                                              data-name="subscribe"><?= GetMessage('SUBSCRIBE_TITLE') ?><?= CPriority::showIconSvg(SITE_TEMPLATE_PATH . '/images/include_svg/subscribe.svg') ?></span>
                                    </div>
                                </div>
                            <? endif; */ ?>
                            <div class="col-md-12 col-sm-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="phone blocks">
                                    <div class="inline-block">
                                        <img style="margin-right: 12px" src="/images/Frame.svg"/>
                                        Режим работы
                                    </div>
                                    <? if (CPriority::GetFrontParametrValue("CALLBACK_BUTTON_FOOTER") == "Y"): ?>
                                        <div class="inline-block callback_wrap">
                                            <span class="callback-block animate-load twosmallfont colored"
                                                  data-event="jqm"
                                                  data-param-id="<?= CPriority::getFormID("aspro_priority_callback"); ?>"
